...
knitr::include_graphics("./pictures/food.jpeg")
```
...
```{r, echo=FALSE, out.width="50%", fig.align = 'center'}
knitr::include_graphics("./pictures/airport-lounges.webp")
```
...
```{r, echo=FALSE, out.width="50%", fig.align = 'center'}
knitr::include_graphics("./pictures/shopping.jpeg")
```
...
```{r, echo=FALSE, out.width="50%", fig.align = 'center'}
knitr::include_graphics("./pictures/wifi.jpeg")
```
...
```{r, echo=FALSE, out.width="50%", fig.align = 'center'}
knitr::include_graphics("./pictures/sightseeing.jpeg")
```
