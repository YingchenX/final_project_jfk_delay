...
## LAX and SFO {.tabset}
We found that LAX and SFO have outstanding delay counts, so we decide to take a closer look at the underlying factors behind those delays.
...
We can clearly observe that the delay times are clustered before  minutes. For the following explorations, we filtered the delay minutes between 0 to 180 minutes. 
