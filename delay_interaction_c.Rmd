...
We observed that between-group differences existed, and adding interaction terms between the categorical predictors could be one of the options for building the linear regression model. In our further analysis, we would mainly focus on the interaction between month and airline. 
