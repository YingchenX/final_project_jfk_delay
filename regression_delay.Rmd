...
\ 5. Inefficient predictive modeling. Although we do not need to worry too much about the parsimony of the model when doing prediction, the number of parameters in model 1 is still too many compared to the usual predictive model. Meanwhile, even with 5 predictors, the R-square is still not strong, thus I doubt the efficiency of our final model.
